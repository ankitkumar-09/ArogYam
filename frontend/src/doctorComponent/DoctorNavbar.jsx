      ...
      <aside className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:w-64 lg:flex lg:flex-col bg-white border-r shadow-sm z-40">
        <div className="h-16 flex items-center px-4">
          <Link to="/doctor/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-gray-800">Arog<span className={`${role === 'doctor' ? 'text-red-500' : 'text-green-500'}`}>Yam</span></span>
          </Link>
        </div>
        ...
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link to="/doctor/dashboard" className="flex items-center gap-2">
              ...
              <span className="font-bold text-md text-gray-800">Arog<span className={`${role === 'doctor' ? 'text-red-500' : 'text-green-500'}`}>Yam</span></span>
            </Link>
          </div>
